...
const TypeAccount = {
	conta_corrente: strings('bank_lib.individual'),
	conta_corrente_conjunta: strings('bank_lib.corporative'),
};
...
const BankFormBrasil = (props, ref) => {
	...
	const hide = () => {
		...
		if(bank){
			if(type &&( ag || !bank.agency_max_length )&& ac){
